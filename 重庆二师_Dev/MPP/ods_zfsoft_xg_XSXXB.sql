...
"XSQRXXBZ" VARCHAR(4 )   NULL COMMENT  '学生确认信息标志',
...
"CSDS" VARCHAR(64 ) NULL ,
"CSDSHI" VARCHAR(64 ) NULL ,
"CSDXIAN" VARCHAR(64 ) NULL ,
