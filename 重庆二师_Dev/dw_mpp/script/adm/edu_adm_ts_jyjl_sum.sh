...
base=$(dirname $0)
conn=$1
sql="TRUNCATE TABLE adm.edu_adm_ts_jyjl_sum;
INSERT INTO adm.edu_adm_ts_jyjl_sum
SELECT G.XH, H.ZYM, H.ZYM_MC, H.SSYXM, H.SSYXM_MC, G.TSMC, G.WJSJ, H.TS_ZJSCS, I.TSLB_MC, J.TS_ZXHTS, H.TS_YJJSCS
FROM
(
