...
*/
use fdm;
DROP TABLE IF EXISTS `edu_fdm_ky_lw_ry`;
CREATE TABLE IF NOT EXISTS `edu_fdm_ky_lw_ry` (
  ...
  `JSM` char(3) DEFAULT NULL COMMENT '角色码,见[edu_hb_js]码表',
...
)DEFAULT CHARSET=utf8 COMMENT='[科研-论文人员]人员基础表,全量更新';