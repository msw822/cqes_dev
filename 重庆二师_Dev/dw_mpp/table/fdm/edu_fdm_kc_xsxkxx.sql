...
CREATE TABLE IF NOT EXISTS fdm.edu_fdm_kc_xsxkxx(
  `KCDM` varchar(64) NOT NULL COMMENT '课程号',
  `KXH` varchar(64) NOT NULL COMMENT '课序号',
  `XKNJ` varchar(4) NOT NULL COMMENT '选课年级',
  `XKXND` varchar(30) NOT NULL COMMENT '选课学年度',
  `JSZGH` varchar(20) NOT NULL COMMENT '教师职工号',
  `XH` varchar(20) NOT NULL COMMENT '学号',
  `XKKH` varchar(20) NOT NULL COMMENT '选课课号',
  `XKRSXD` int(11) NOT NULL COMMENT '选课人数限定',
