...
CREATE TABLE IF NOT EXISTS FDM.EDU_FDM_XS_XJXX (
  ...
  "RXNY" varchar(20) COMMENT '入学年月,YYYYMM格式',
  "XSLBM" varchar(10) DEFAULT NULL COMMENT '见学生类别码表[edu_hb_xslb]',
  ...
  "XKMLM" varchar(20) DEFAULT NULL COMMENT '学科门类码，见[edu_hb_xkml]',
  "PYFSM" varchar(20) DEFAULT NULL COMMENT '培养方式码，见[edu_hb_pyfs]',
  "YJFX" varchar(100) DEFAULT NULL COMMENT '研究方向',
  "DSH" varchar(20) DEFAULT NULL COMMENT '导师号',
  "HDXLFSM" varchar(10) DEFAULT NULL COMMENT '获得学历方式码，见[edu_hb_hdxlfs]',
  "SFXFZ" varchar(10) DEFAULT NULL COMMENT '是否学分制',
  "PYCCM" varchar(10) DEFAULT NULL COMMENT '培养层次码，见[edu_hb_pycc]',
  "LDFSM" varchar(10) DEFAULT NULL COMMENT '连读方式码，学校自编',
