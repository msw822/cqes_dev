...
*/
use fdm;
DROP TABLE IF EXISTS `edu_fdm_ky_zl_ry`;
CREATE TABLE IF NOT EXISTS `edu_fdm_ky_zl_ry` (
  ...
  `JSM` char(3) DEFAULT NULL COMMENT '角色码,JY/T 1001 JS 角色代码[edu_hb_js]',
